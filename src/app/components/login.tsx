...
const LoginScreen: React.FC<LoginScreenProps> = ({ isOpen, onClose }) => {
  ...
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
    ...
    <line x1="6" y1="6" x2="18" y2="18"></line>
        ...
        <div className={styles.countContainer}>
          ...
          <div className={styles.subtext}>are matching now!</div>
        </div>
        ...
        <div className={styles.authButtons}>
          ...
          <button 
            className={`${styles.authButton} ${styles.apple}`}
        ...
        <div className={styles.links}>
          <span>By continuing, you agree to our <a>Terms & Conditions</a></span>
